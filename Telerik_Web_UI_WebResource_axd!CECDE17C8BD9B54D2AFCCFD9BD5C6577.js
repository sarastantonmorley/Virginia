...
/* END AjaxPro.core.js */
/* START TrainingAssist.Presentation.Pages.Scripts.evidenceSummary.js */
/*Evidence summary UI process start and link goto*/
 function Evidence_Summary_StartEvidenceSummaryUIProcess()
 {
   try
   {
       AddProcessLinkToBrowserCache("Evidence Summary",window.location.href);
   }
   catch (e)
   {
       helper.OnAborted();   
 ...
 function Evidence_Summary_NavigateToEvidence(linkId)
 {
    Evidence_Summary_StartEvidenceSummaryUIProcess();
    return site_NavigateViaLinkId(linkId);
 }

/* END TrainingAssist.Presentation.Pages.Scripts.evidenceSummary.js */
